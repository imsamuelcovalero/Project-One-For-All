...
INSERT INTO SpotifyClone.user_plan (plan, plan_value)
VALUES
  ('gratuito', 0),
  ('familiar', 7.99),
  ('universitário', 5.99),
...
INSERT INTO SpotifyClone.songs (song, duration_secs, album_id, artist_id)
VALUES
    ('Soul For Us', 200, 1, 1),                         
    ...
    ('Honey, Im A Lone Wolf', 150, 7, 5),
    ('She Thinks I Wont Stay Tonight', 166, 8, 5),
    ('He Heard Youre Bad For Me', 154, 8, 5),
    ('He Hopes We Cant Stay',	210,	8, 5),
    ('I Know I Know', 117, 8, 5),
    ('Hes Walking Away', 159, 9, 5),
    ('Hes Trouble', 138, 9, 5),
    ('I Heard I Want To Bo Alone', 120, 9, 5),
    ('I Ride Alone', 151, 9, 5),
    ('Honey', 79, 10, 6),
    ('You Cheated On Me', 95, 10, 6),
    ('Wouldnt It Be Nice', 213, 10, 6),
    ('Baby', 136, 10, 6),
    ('You Make Me Feel So.', 83, 10, 6);


INSERT INTO SpotifyClone.reproduction_history (reproduction_date, user_id, song_id)
VALUES
